		...
		<div id="content" class="container">
			...
			<div class="form-group">
            	<?php echo form_label($this->lang->line('create_user_password_confirm_label'), 'password_confirm', 
					array('class' => 'col-sm-2 control-label'));?> 
            	<div class="col-sm-3"><?php echo form_input($password_confirm, NULL, 'class="form-control"');?></div>
      		</div>
			<div class="form-group">
          		<div class="col-sm-offset-2 col-sm-10"><?php echo form_submit(array('name' => 'submit', 'value' => 'Create', 
